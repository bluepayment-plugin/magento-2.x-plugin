...
3. Fill in the details of supported currencies (you will receive them from Blue Media)
   ...
   2. **Configuration key** - you will receive it from BM, you can also read it in the PayBM panel [Acceptance Environment](https://oplacasie-accept.bm.pl/admin), [Production Environment](https://oplacasie.bm.pl/admin) in the service details as **Konfiguracja hasha** -> **klucz**
